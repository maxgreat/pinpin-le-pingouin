...
public class SelectionJoueurs{
	...
	JButton b1;
	if (this.menu == 1)
		b1 = new JButton(new ImageIcon("Interface/Graphique/Img/selectedHumain1.png"));
	else
		b1 = new JButton(new ImageIcon("Interface/Graphique/Img/joueurHumain"+menu+".png"));
	...
	b2.setOpaque(false);	
	JButton b3;
	if (this.menu == 3 || menu == 4)
		b3 = new JButton(new ImageIcon("Interface/Graphique/Img/selectedAucun"+menu+".png"));
	else 
		b3 = new JButton(new ImageIcon("Interface/Graphique/Img/aucun.png"));
	...
	b3.setOpaque(false);	
        ...
        b1.addActionListener(new EcouteurBoutonMenuPerso(this, partage, 1, b1, b2, b3, menu));
        b2.addActionListener(new EcouteurBoutonMenuPerso(this, partage, 2, b1, b2, b3, menu));
        b3.addActionListener(new EcouteurBoutonMenuPerso(this, partage, 3, b1, b2, b3, menu));
