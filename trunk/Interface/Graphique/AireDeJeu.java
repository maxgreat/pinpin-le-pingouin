...
public class AireDeJeu extends JComponent
{
    ...
    private void afficherCarres(Graphics2D drawable, int margeGauche, int margeHaut)
    {
		...
		drawable.drawString("Joueur 1", margeGauche/3 - 10,margeHaut/4);	
		drawable.drawString("Score " + inter.joueurs[0].getScore(), 20,2*margeHaut/4);	
		drawable.drawString("Tuiles " + inter.joueurs[0].getNombreTuile(), 20,3*margeHaut/4);
		...
		drawable.drawString("Score " + inter.joueurs[1].getScore(),largeur-margeGauche+20,2*margeHaut/4);
